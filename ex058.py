# IGUAL AO EX028 SÓ ADICIONEI A QUANTIDADE DE TENTATIVAS DA PESSOA QUANDO ACERTA
...
for rodada in range(1, tentativas + 1):
    ...
    if acertou:
        print(Fore.BLUE + Style.BRIGHT + f"Parabéns, você acertou em {rodada} tentativas!")
        break
